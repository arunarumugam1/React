  ...
  <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li className="nav-item active">
                        <Link to='/home1' className="nav-link bg-light">Home</Link>
                    </li>
                    <li className="nav-item">
                        <Link to='/work' className="nav-link bg-light">Work</Link>
                    </li>
                    <li className="nav-item">
                        <Link to='/form' className="nav-link bg-light">Form</Link>
                    </li>
                    <li className="nav-item">
                        <Link to='/about' className="nav-link bg-light">About</Link>
                    </li>
                    <li className="nav-item">
                        <Link to='/testimonial' className="nav-link bg-light">Teatimonial</Link>
                    </li>
                    <li className="nav-item">
                        <Link to='/products' className="nav-link bg-light">Products</Link>
                    </li>
                    <li className="nav-item">
                        <Link to='/conclution' className="nav-link bg-light">Conclution</Link>
                    </li>
